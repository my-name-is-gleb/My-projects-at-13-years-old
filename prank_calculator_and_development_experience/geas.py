...
while True:
    ...
    mathematical_operation = input("Введите математическое действие(+, -, *, /): ")
    if mathematical_operation in ("*", "+", "-", "/"):
        break
    else:
        print("Ваши даные были не правильные. Попробуйте снова!")
        continue
...
#     [/bold]
#     
#     [blink]СИСТЕМА УНИЧТОЖЕНА / SYSTEM PURGED[/blink]
#     """
#     
#     console.print(Panel(
#         final_text, 
#         title="[bold yellow]SYSTEM FAILURE[/bold yellow]", 
